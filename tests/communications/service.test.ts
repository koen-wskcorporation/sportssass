...
mock.module("@/modules/communications/db/queries", { namedExports: createQueriesMock(state) });
let service!: typeof import("@/modules/communications/service");
...
before(async () => {
  service = await import("@/modules/communications/service");
});
