import { nameSimilarity, normalizeDisplayName, normalizeEmail, normalizePhone } from "@/modules/communications/normalization";
import type { CommContact, ContactCandidate, ContactMatchReasonCode, InboundIdentityHints } from "@/modules/communications/types";
