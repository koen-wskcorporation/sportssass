...
import { saveProgramHierarchyAction, saveProgramScheduleAction, updateProgramAction } from "@/src/features/programs/actions";
import { ScheduleBuilderPage } from "@/src/features/programs/schedule/components/ScheduleBuilderPage";
import type { ProgramNode, ProgramOccurrence, ProgramScheduleException, ProgramScheduleRule, ProgramTeamSummary, ProgramWithDetails } from "@/src/features/programs/types";
import { isProgramNodePublished } from "@/src/features/programs/utils";
import { getProgramTeamsOverviewAction } from "@/src/features/programs/teams/actions";
  ...
  return (
    <div className="ui-stack-page">
                  ...
                  {linkedForms.map((form) => (
                    <div className="flex flex-wrap items-center justify-between gap-3 rounded-control border bg-surface px-3 py-3" key={form.id}>
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        <Link className="text-sm font-semibold text-accent hover:underline" href={`/tools/forms/${form.id}/editor`}>
                          Manage form
                        </Link>
                      </div>
                    </div>
      ...
      >
        ...
        popupClassName="w-[min(520px,calc(100vw-1.5rem))] sm:w-[min(520px,calc(100vw-3rem))]"
      ...
      {activeSection === "schedule" ? (
        // Dedicated builder workflow: schedule editing stays as a full workspace route.
        <ScheduleBuilderPage
          canWrite={canWritePrograms}
